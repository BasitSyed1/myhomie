...
class PropertScreen extends StatefulWidget {
  const PropertScreen({super.key});

  @override
  State<PropertScreen> createState() => _PropertScreenState();
}

class _PropertScreenState extends State<PropertScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Center(child: Text('Property')),),
      body: Padding(
